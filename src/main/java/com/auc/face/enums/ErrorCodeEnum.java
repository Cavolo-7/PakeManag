...
public enum ErrorCodeEnum {
    ...
    public static com.auc.face.enums.ErrorCodeEnum getDescriptionByCode(Integer code){
        for(com.auc.face.enums.ErrorCodeEnum errorCodeEnum : com.auc.face.enums.ErrorCodeEnum.values()){
            if(code.equals(errorCodeEnum.getCode())){
                return errorCodeEnum;
            }
        }
        return  com.auc.face.enums.ErrorCodeEnum.UNKNOWN;
    }
