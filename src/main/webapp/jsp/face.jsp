...
<head>
    ...
    <link rel="stylesheet" href="../face/facestatic/layui/css/layui.css">

    <script src="../face/facestatic/jquery/jquery-3.3.1.min.js"></script>
...
<div class="layui-tab">
    ...
    <div class="layui-tab-content" style="">
        <div class="layui-tab-item layui-show"><%@ include file="facesystem.jsp" %></div>
        <div class="layui-tab-item"><%@ include file="facesearch.jsp" %></div>
    </div>
</div>
