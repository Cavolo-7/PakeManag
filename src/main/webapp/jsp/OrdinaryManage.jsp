    ...
    layui.use(['form', 'table'], function () {
        ...
        table.render({
            ...
            , cols: [[
                ...
                , {field: 'personAccount', title: '用户账号', width: '5%',align: 'center'}
                ...
                , {field: 'personRecharge', title: '用户总消费', width: '10%',align: 'center'}
